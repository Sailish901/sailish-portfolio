  ...
  return (
    <div className='border-b-2 border-neutral-900 text-white py-12'>
      ...
      <div className='flex flex-col lg:flex-row mx-6'>
        <div className='w-full lg:w-1/2 h-[400px] p-6'>
        ...
        <motion.div whileInView={{x:0,opacity:1}} animate={{x:100,opacity:0}} transition={{delay:0.5,duration:1.3}} className='w-full lg:w-1/2 p-6'>
