...
const Technology = () => {
  ...
  return (
    <div className='my-8 border-b-2 border-neutral-900'>
        <motion.h1  initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:0.5,delay:1}} className=' flex justify-center items-center  text-7xl font-thin tracking-tighter text-white'>Tech Stack</motion.h1>
       <motion.div initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:0.5,delay:1.5}} className='my-[80px] flex justify-center items-center gap-4'>
        <br/>
            ...
            <motion.div variants={icons(5)} initial="initial" animate="animate" className='rounded-2xl border-2  border-neutral-800 p-4'>
                <FaJava ndCpp style={{color:'yellow',backgroundColor:'rgba(0,0,0)'}} className='text-4xl'></FaJava>
            </motion.div>
            <motion.div variants={icons(2)} initial="initial" animate="animate" className='rounded-2xl border-2  border-neutral-800 p-4'>
